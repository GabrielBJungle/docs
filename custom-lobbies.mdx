...
# FTW Custom Lobby (Upcoming Feature)

The FTW Custom Lobby will be a powerful feature designed to seamlessly connect players within and outside the game, allowing them to create custom lobbies, issue challenges, and manage match participation through integrated notifications.
